...
if __name__ == '__main__':
    ...
    argparser.add_argument('--max_length', help='句子最大长度', type=int,
                           default=36)
    ...
    argparser.add_argument('--result_path', help='训练结果存储路径', type=str,
                           default='result/base_bert_ft6_triplet_nopos.txt')
    ...
    argparser.add_argument('--regularization', help='使用什么正则化 比如lwf', type=str, default='nl2')
    argparser.add_argument('--session_epoch', help='增量任务轮次', type=int, default=0)
    argparser.add_argument('--random_test', help='是否随机抽取session数据', type=bool, default=False)
